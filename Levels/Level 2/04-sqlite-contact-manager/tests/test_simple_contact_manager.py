"""
Comprehensive test suite for Simple SQLite Contact Manager.
"""
...
from sqlite_contact_manager.simple_core import SimpleContactManager


class TestSimpleContactManager:
    """Test cases for SimpleContactManager class."""
    ...
    def manager(self, temp_db):
        """Create SimpleContactManager instance with temporary database."""
        # Ensure clean database for each test
        if os.path.exists(temp_db):
            os.unlink(temp_db)
        return SimpleContactManager(temp_db)

    def test_database_initialization(self, temp_db):
        """Test database initialization creates required tables."""
        manager = SimpleContactManager(temp_db)
